...
const updateView = () => {
    ...
    taskArr.forEach((Element, index) => {
        ...
        taskEdit.innerHTML = "Edit <i class='icon-edit icon-large'></i>";
        ...
        taskDelete.innerHTML = "Delete <i class='icon-trash icon-large'></i>";
        ...
        taskDo.innerHTML = Element.isDone ? "Undo <i class='icon-undo icon-large'></i>" : "Done <i class='icon-ok-sign icon-large'></i>";
    ...
    document.getElementById("task-clear-btn").style.display = taskArr.length > 0 ? "block" : "none"
}
...
document.addEventListener("DOMContentLoaded", () => {
    document.getElementsByClassName("text-mark-ok")[0].style.display = "none";
...
document.getElementById("task-input").addEventListener("keypress", function(event) { 
    ...
    document.getElementsByClassName("text-mark-ok")[0].style.display = ( document.getElementById("task-input").value === '' ) ? "none" : "block"
